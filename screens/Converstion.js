    ...
    <View>
      ...
      <View
        ...
        <View
          ...
          <View style={{width:wp('20%'),height:hp('5%'),marginTop:5,marginLeft:wp('4%')}}>
          ...
          <Menu
            ...
            anchor={
              <TouchableOpacity onPress={showMenu}>
                <View style={{width:wp('20%'),height:hp('5%'),borderWidth:0.5,borderRadius:10,backgroundColor:'#65DFEA'}}>
              <Text style={{textAlign:'center',justifyContent:'space-around',marginTop:9}}>{display}</Text> 
                </View>
              </TouchableOpacity>
            }
            onRequestClose={hideMenu}>
            <MenuItem onPress={()=>{hideMenu(false),setValue('0'),setdisplay('Open')}}>Open</MenuItem>
            <MenuItem onPress={()=>{hideMenu(false),setValue('1'),setdisplay('Hold')}}>Hold</MenuItem>
            <MenuItem onPress={()=>{hideMenu(false),setValue('3'),setdisplay('Close')}}>Close</MenuItem>
          </Menu>
          </View>
